			...
			<div class="row">
				...
				<div class="l-6 hide-on-tablet_mobile">
                    <ul class="header__nav__container--list">
                      ...
                      <li><a href="#" class="active">Bài viết mới</a></li>
...
<div class="header__menu">
	...
	<div class="header__menu__body--content">
		<ul>
			<li><a href="{{ route('home') }}">Trang chủ</a></li>
			<li><a class="active" href="#">Bài viết mới</a></li>
			<li><a href="{{ route('blog.index') }}">Blog</a></li>
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle user-profile" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
					@if(Auth::user()->image)
					...
					<div class="contact__container__form">
						...
						<div class="contact__form">
                            <form enctype="multipart/form-data" action="/blog" method="POST">
                                @csrf
							<input type="text" placeholder="Tiêu đề" class="contact_form_name" name="title">
							<input type="text" placeholder="Địa điểm" class="contact_form_email" name="area">
                            <input type="file" name="image" placeholder="Tải ảnh lên  +  " class="contact_form_subject">
                            <textarea name="content" id="" cols="30" rows="10" placeholder="Cảm nghĩ của bạn"></textarea>
							<div class="row">
								<div class="l-12 m-12 c-12 text-center"><button type="submit" class="form_submit_button">Đăng<span></span><span></span><span></span></button></div>
							</div>
                        </form>
						</div>
					</div>
